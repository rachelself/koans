...
class AboutIteration < Neo::Koan
  ...
  def test_inject_will_blow_your_mind
    ...
    # Inject allows you to introduce a new item into an array,
    # shown as a variable that you can use to transform the array...
  end
  ...
  # Looks like this is just using the method instead of setting the
  # variable also
end
